    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-950 p-4">
      <div className="bg-stone-900/60 backdrop-blur-md border border-stone-800 rounded-xl shadow-2xl p-8 sm:p-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-light text-white/80">Criar Nova Conta de Acesso</h2>
        </div>
        ...
        <form className="space-y-4">
          ...
          {/* CAMPO NOME */}
          <div>
            <label htmlFor="nome" className="block text-sm font-medium text-white/90 mb-2">Nome Completo</label>
            <div className="relative">
              ...
              />
              <i className="fas fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-amber-500"></i>
            </div>
          </div>
          ...
          <div>
            <label htmlFor="confirmarSenha" className="block text-sm font-medium text-white/90 mb-2">Confirmar Senha</label>
            <div className="relative">
              <input
                id="confirmarSenha"
                type="password"
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-amber-600 text-white font-bold rounded-lg hover:bg-amber-700 transition-colors shadow-lg shadow-amber-900/50 text-lg mt-6"
          >
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-white/70">
            Já tem uma conta? 
            <Link to="/login" className="text-amber-400 hover:text-amber-300 transition-colors ml-1 font-semibold">
              Fazer Login
            </Link>
          </p>
        </div>
