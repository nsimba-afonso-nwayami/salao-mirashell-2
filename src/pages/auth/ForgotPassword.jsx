    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-950 p-4">
      <div className="bg-stone-900/60 backdrop-blur-md border border-stone-800 rounded-xl shadow-2xl p-8 sm:p-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-light text-white/80">Recuperar Acesso</h2>
        </div>

        <p className="text-white/70 mb-6 text-center">
            Insira o seu endereço de e-mail abaixo. Enviaremos um link para que possa redefinir a sua senha.
        </p>
        ...
        <form className="space-y-6">
          ...
          {/* CAMPO E-MAIL */}
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-white/90 mb-2">E-mail de Cadastro</label>
